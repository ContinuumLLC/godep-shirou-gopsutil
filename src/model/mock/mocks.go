...
// Source: github.com/ContinuumLLC/platform-asset-plugin/src/model (interfaces: AssetServiceFactory,HandlerDependencies,AssetService,AssetServiceFactory,AssetCollectionServiceDependencies,AssetDal,AssetCollectionDalFactory,AssetCollectionDalDependencies,ConfigServiceFactory,ConfigService,ConfigDal,ConfigDalDependencies,ConfigDalFactory,ConfigServiceDependencies)
...
func (_m *MockAssetServiceDependencies) GetAssetCollectionService(_param0 model.AssetCollectionServiceDependencies) model.AssetService {
...
func (_m *MockAssetCollectionServiceFactory) GetAssetCollectionService(_param0 model.AssetCollectionServiceDependencies) model.AssetService {
	ret := _m.ctrl.Call(_m, "GetAssetCollectionService", _param0)
	ret0, _ := ret[0].(model.AssetService)
	return ret0
}
