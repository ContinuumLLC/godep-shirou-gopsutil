...
// Source: github.com/ContinuumLLC/platform-asset-plugin/src/model (interfaces: AssetServiceFactory,HandlerDependencies,AssetCollectionService,AssetCollectionServiceFactory,AssetCollectionServiceDependencies,AssetDal,AssetCollectionDalFactory,AssetCollectionDalDependencies,ConfigServiceFactory,ConfigService,ConfigDal,ConfigDalDependencies,ConfigDalFactory,ConfigServiceDependencies)
...
func (_m *MockAssetServiceDependencies) GetAssetCollectionDal(_param0 model.AssetCollectionDalDependencies) model.AssetDal {
...
func (_m *MockAssetCollectionServiceDependencies) GetAssetCollectionDal(_param0 model.AssetCollectionDalDependencies) model.AssetDal {
	ret := _m.ctrl.Call(_m, "GetAssetCollectionDal", _param0)
	ret0, _ := ret[0].(model.AssetDal)
	return ret0
}
...
func (_m *MockAssetCollectionDalFactory) GetAssetCollectionDal(_param0 model.AssetCollectionDalDependencies) model.AssetDal {
	ret := _m.ctrl.Call(_m, "GetAssetCollectionDal", _param0)
	ret0, _ := ret[0].(model.AssetDal)
	return ret0
}
